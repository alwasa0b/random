...
hand3=[[10, 'c'], [5, 'c'], [5, 'c'], [5, 'a'], [5, 'a']]
hand4=[[1, 'c'], [1, 'a'], [4, 'o'], [8, 'c'], [8, 'i']]
hand5=[[1, 'c'], [1, 'c'], [3, 'c'], [4, 'c'], [5, 'c']]
hand6=[[1, 'c'], [2, 'c'], [3, 'c'], [4, 'c'], [5, 'p']]
hand7=[[1, 'c'], [8, 'c'], [1, 'c'], [1, 'h'], [2, 'c']]

hand8=[[1, 'c'], [9, 'c'], [1, 'c'], [5, 'h'], [9, 'c']]
...
print fourOfAkind(hand3)
print fulHouse(hand4)
print flush(hand5)
